...
if(select=='Intro'):
    ...
    st.header('About')
    st.text('  \n')
    st.markdown('''<span style="font-weight: bold;">This Project Was Created By Soham Shah. I Am a Machine Learning and Deep Learning And a Data Science Enthusiast.
    ...
    if st.button("GitHub Profile"):
        st.markdown('[Visit Now!](https://github.com/Soham-A-Shah)')
    if st.button("LinkedIn Profile"):
        st.markdown('[Visit Now!](https://www.linkedin.com/in/soham-shah-561216159)')
